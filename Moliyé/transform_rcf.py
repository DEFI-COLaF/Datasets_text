...
def read_wiki_poems(poems_link):
    source = m_util.get_html_content(poems_link)
...
caulier_link = "https://creolica.net/Edition-de-deux-textes-religieux"
fables_link = "https://fr.wikisource.org/wiki/Fables_cr%C3%A9oles"

deux = read_deux_textes(caulier_link)
